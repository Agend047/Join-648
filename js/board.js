...
<div>
  ...
  <div class="error-container">
    <div class="error-message" id="prio-input-error"></div>
  </div>
</div>
...
<div>
  ...
  >
    <ul id="assigned-to-options" class="select-options assigned-to-options">
      <li class="assign-to-li" value="niklas">
        <svg
          width="42"
          height="42"
          viewBox="0 0 42 42"
        ...
        <span class='assign-to-li-name'>Niklas</span>
        <img src="./assets/img/checkbox-unchecked.svg" />
      </li>
      <li class="assign-to-li" value="susanne">
        <svg
          width="42"
          height="42"
          viewBox="0 0 42 42"
        ...
        <span class='assign-to-li-name'>Susanne</span>
        <img src="./assets/img/checkbox-unchecked.svg" />
      </li>
      <li class="assign-to-li" value="susanne">
        <svg
      ...
      <li class="assign-to-li" value="jan">
        <svg
          width="42"
          height="42"
          viewBox="0 0 42 42"
        ...
        <span class='assign-to-li-name'>Jan</span>
        <img src="./assets/img/checkbox-unchecked.svg" />
      </li>
    </ul>
